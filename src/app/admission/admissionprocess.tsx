...
export default function AdmissionProcess() {
  return (
    <div className="relative w-full max-w-6xl mx-auto px-4 py-12 font-[Inter] h-[1953px]">
      {/* Header Section */}
      <div className="text-center mb-12">
        <h1 className="text-[#1a237e] text-2xl md:text-3xl font-bold mb-4">
      ...
      {/* Road Map Container */}
      <div className="relative w-[95%] h-[2200px] mx-auto">
        {/* First road path image */}
        ...
        {/* Step 1 */}
        <div className="absolute top-0 right-[8%] w-[400px] bg-white rounded-lg border-[1px] border-[#012060] p-5 z-10 shadow-[7px_6px_#AA81D2]">
        ...
        {/* Step 2 */}
        <div className="absolute top-[12%] left-[-100px] w-[280px] bg-white rounded-lg border-[1px] border-[#012060] p-5 z-10 shadow-[-6px_6px_#F5989B]">
        ...
        {/* Step 3 */}
        <div className="absolute top-[26%] right-[12%] w-[340px] bg-white rounded-lg border-[1px] border-[#012060] p-5 z-10 shadow-[7px_6px_#EBE847]">
        ...
        {/* Step 4 */}
        <div className="absolute top-[35%] left-[2%] w-[339px] bg-white rounded-lg border-[1px] border-[#012060] p-5 z-10 shadow-[-6px_6px_#BBD5FF]">
          <h2 className="font-[900] mb-2 text-center ">STEP 4: PERSONAL INTERVIEW (PI) AND GROUP DISCUSSION (GD)</h2>
          <p className="text-center text-sm">
            Participate in evaluations covering communication, problem-solving, and leadership potential. 
            GD topics will be shared in advance.
          </p>
        </div>

        {/* Step 5 */}
        <div className="absolute top-[53%] left-[-2%] w-[368px] bg-white rounded-lg border-[1px] border-[#012060] p-5 z-10 shadow-[-6px_6px_#AA81D2]">
          <h2 className="font-bold mb-2 text-center">STEP 5: FINAL SELECTION</h2>
          <p className="text-sm text-center">
            Final selection is based on entrance scores, academic record, and performance in PI/GD. 
            Selected candidates receive a provisional admission letter.
          </p>
        </div>

        {/* Step 6 */}
        <div className="absolute bottom-[25%] right-[11%] w-[340px] bg-white rounded-lg border-[1px] border-[#012060] p-5 z-10 shadow-[7px_6px_#F5989B]">
