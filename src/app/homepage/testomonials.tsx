...
const testimonials = [
  {
    id: 1,
    quote:
      "Thanks to [Your Firm Name], I made it to IIM Ahmedabad! The team helped in choosing the right schools and was a great support throughout the essay-writing and the interview prep. Their expertise was the icing on the cake!",
    author: "[Client Name]",
    role: "IIM Ahmedabad",
...
export default function TestimonialSection() {
  ...
  return (
    <section className="bg-gray-100 py-12 sm:py-16 " aria-labelledby="testimonial-heading">
      <div className="max-w-4xl mx-auto">
        ...
        <Carousel className="w-[90%] px-4 sm:px-6 lg:px-8">
          <CarouselContent>
